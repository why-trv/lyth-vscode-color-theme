...
const definition: ThemeDefinition = {
  ...
  colors: {
    ...
    terminal: {
      ...
      ansiRed: lch(0.78, 0.115, 2.8),
      ansiGreen: lch(0.78, 0.115, 140),
      ansiYellow: lch(0.78, 0.08, 86.5),
      ansiBlue: lch(0.78, 0.115, 259.9),
      ansiMagenta: lch(0.78, 0.08, 336.3),
      ansiCyan: lch(0.78, 0.07, 182.7),
      ansiWhite: lch(0.78, 0.04, 272.9),
      ansiBrightBlack: lch(0.477, 0.034, 278.6),
      ansiBrightRed: lch(0.83, 0.13, 2.8),
      ansiBrightGreen: lch(0.83, 0.13, 142.7),
      ansiBrightYellow: lch(0.83, 0.08, 86.5),
      ansiBrightBlue: lch(0.83, 0.13, 259.9),
      ansiBrightMagenta: lch(0.83, 0.08, 336.3),
      ansiBrightCyan: lch(0.83, 0.07, 182.7),
      ansiBrightWhite: lch(0.83, 0.04, 273.9),
    },
    terminalCursor: {
